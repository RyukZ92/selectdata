...
--
-- Servidor: localhost
-- Tiempo de generación: 27-06-2017 a las 22:23:06
...
INSERT INTO `certificados` (`id`, `curriculo`, `descripcion`, `institucion`, `fecha`) VALUES
(1, 1, '', '', '0000-00-00'),
(2, 2, '', '', '0000-00-00'),
(3, 3, '', '', '0000-00-00'),
(4, 3, '', '', '0000-00-00'),
...
(3, 'Obrero', 'TSU Ingormática', 'Vigilante', '2017-06-21', '', 'img/fotos/foto-3.png', 1),
...
--
-- Volcado de datos para la tabla `cursos_realizados`
--

INSERT INTO `cursos_realizados` (`id`, `curriculo`, `descripcion`, `duracion`, `fecha`) VALUES
(1, 1, 0, '', ''),
(2, 2, 0, '', ''),
(3, 3, 0, '', ''),
(5, 4, 0, '', ''),
...
(1, 'Admin', 'Admin', 'V-0000000', '', '0000-00-00', '', '', '', '', '', '', '2017-06-27', '22:18:40', 0),
...
(1, 3, 'No Seleccionado', 4, 'No cumple', '2017-06-20'),
(2, 7, 'No Seleccionado', 4, 'No califica', '2017-06-27'),
(3, 5, 'Seleccionado', 4, '', '2017-06-20'),
(4, 6, 'No Seleccionado', NULL, '6', '2017-06-20'),
(5, 8, 'En Proceso', NULL, '', '2017-06-14'),
(24, 9, 'En Proceso', NULL, '', '2017-06-17'),
(25, 10, 'Pre Seleccionado', 4, '', '2017-06-27'),
(26, 11, 'Seleccionado', 4, '', '2017-06-21'),
(27, 14, 'Seleccionado', 4, '', '2017-06-27'),
(28, 15, 'Seleccionado', NULL, '', '2017-06-27');
...
(1, 3, 'Ayudante', '', 'PDVSA', 1991, 2003, '7', '12'),
(2, 3, 'Desarrollador de software', '', 'Microsotf', 2012, 2015, '3', '10'),
...
(3, 3, 'Técnico Superior Universitario', 'UDO Carúpano', 2006, 2009),
...
(1, 1, 0, 'Admin', 'eMfPoqOUlJZn', '641af4d1409ca4c1c41baeebaa95c14643472dc3', '', '', '', 'Admin', '2017-06-10', '06:30:41', '2017-06-27', '22:18:40'),
...
--
-- Indices de la tabla `cursos_realizados`
--
...
--
-- AUTO_INCREMENT de la tabla `cursos_realizados`
--
ALTER TABLE `cursos_realizados`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `certificados`
ADD CONSTRAINT `certificados_ibfk_1` FOREIGN KEY (`curriculo`) REFERENCES `curriculo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `cursos_realizados`
ADD CONSTRAINT `cursos_realizados_ibfk_1` FOREIGN KEY (`curriculo`) REFERENCES `curriculo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

...
?>
<input type="hidden" id="seleccionado" value="<?php echo $postulante[0]['en_proceso'] ?>">
<input type="hidden" id="no-seleccionado" value="<?php echo $postulante[0]['pre_seleccionado'] ?>">
<input type="hidden" id="pre-seleccionado" value="<?php echo $postulante[0]['seleccionado'] ?>">
<input type="hidden" id="en-proceso" value="<?php echo $postulante[0]['no_seleccionado'] ?>">

...
<?php 
          ...
          $nivel = $_SESSION['nivel'] == "Admin" ? "Administrador": $_SESSION['nivel'];
?>  
            <li class="active">
                <a href="documentos/manual-de-ayuda.pdf" target="_blank"><strong>Manual de Ayuda</strong></a>
            </li>
            </ul>
          <!-- lado derecho --->
            <ul class="nav pull-right">
            <li id="fat-menu" class="dropdown active">
              <a href="#" id="drop3" role="button" class="dropdown-toggle" data-toggle="dropdown"><strong><?php echo $_SESSION['nombre_apellido'] . " (" . $nivel . ")"; ?> </strong> <b class="caret"></b></a>

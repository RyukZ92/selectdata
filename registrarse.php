            ...
            <div class="col-lg-8 nuevo" >
                ...
                <form class="form-horizontal" role="form" method="post" id="form">
                  <div class="form-group">
                    ...
                    <div class="col-lg-2 ">
                        <select name="tipo_cedula" class="form-control requerido" id="tipo_cedula">
                    ...
                    <div class="col-lg-5">
                      <input type="text" class="form-control solo-numero-entero requerido" id="cedula"
                             placeholder="Cédula" name="cedula"
                             value="<?php echo $cedula ?>"
                             maxlength="8" autocomplete="off" 
                             onblur="verificarCedulaExistente(tipo_cedula.value+'-'+this.value);">
                      <small  class="text-danger" id='msj-cedula'></small>
                      <?php echo $msj; ?>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-7 ">
                      <input type="text" class="form-control solo-letras-con-espacio-y-acentos requerido" id="nombre"
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-7 ">
                      <input type="text" class="form-control solo-letras-con-espacio-y-acentos requerido" id="apellido"
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-7 ">
                      <input type="text" class="form-control requerido" id="email" 
                             ...
                             onblur="verificarEmailExistente(this.value);">
                      <small  class="text-danger" id='msj-email'></small>
                      <?php echo $msj; ?>
                    </div>
                    <div class="col-lg-1 ">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-7 ">
                      <input type="text" class="form-control alfanumerico-sin-espacio requerido" id="usuario"
                             ...
                             onblur="verificarUsuarioExistente(this.value);">
                      <small  class="text-danger" id='msj-username'></small>
                      <?php echo $msj; ?>
